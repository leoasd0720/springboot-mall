package com.leoasd0720.springbootmall.dao.impl;
...
import com.leoasd0720.springbootmall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public List<Product> getProducts(ProductQueryParams productQueryParams) {
        ...
        String sql = "SELECT " +
                "product_id, product_name, category, image_url, price, stock, description, " +
    ...
    public void updateProduct(Integer productId, ProductRequest productRequest) {
        String sql = "UPDATE product SET " +
                ...
                "image_url = :image_url, price = :price, stock = :stock, " +
    ...
    public void updateStock(Integer productId, Integer stock) {
        String sql = "UPDATE product SET stock = :stock, last_modified_date = :lastModifiedDated" +
                " WHERE product_id = :productId";
        Map<String, Object> map = new HashMap<>();
        map.put("productId", productId);
        map.put("stock", stock);
        map.put("lastModifiedDated", new Date());
